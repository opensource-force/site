...
export default function Header() {
  ...
  // not sure what the hs-collapse-open is doing
  var closedNavIconClassName = navOpen
    ? "hs-collapse-open:hidden flex-shrink-0 size-4"
    : "hs-collapse-open:hidden hidden flex-shrink-0 size-4";
  var openNavIconClassName = navOpen
    ? "hs-collapse-open:block hidden flex-shrink-0 size-4"
    : "hs-collapse-open:block block flex-shrink-0 size-4";
  var openNavClassName = navOpen
    ? "absolute hidden p-6-rounded-sm left-6 right-6 top-20 z-100"
    : "absolute p-6 rounded-lg bg-gray-200 left-6 right-6 top-20 z-100";
      ...
      >
        <div className="flex items-center justify-between">
          ...
          <div className="sm:hidden">
            ...
            >
              <svg
                className={closedNavIconClassName}
        ...
        <div id="menu" className={openNavClassName}>
